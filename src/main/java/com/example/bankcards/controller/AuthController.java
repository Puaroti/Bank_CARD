...
// Автоматически выпустить карту по умолчанию для нового пользователя (владелец = полное имя, срок действия +4 года)        cardService.issueAutoCard(saved.getId(), saved.getFullName());
